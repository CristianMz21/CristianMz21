...
|---|---|---|
| [**normadocs**](https://github.com/CristianMz21/normadocs) | Document compliance SaaS — multi-tenant | Django · DDD · PostgreSQL |
| [**ecommerce-api**](https://github.com/CristianMz21/ecommerce-api) | Production e-commerce backend | FastAPI · GraphQL · Redis |
| [**Portfolio**](https://cristianarellano.com) | This site — Astro 5, 95+ Lighthouse, A+ security headers | Astro · TypeScript · Cloudflare Pages |
